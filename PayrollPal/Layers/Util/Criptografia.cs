...
namespace PayrollPal.Layers.Util
{
    class Criptografia
    {
        ...
        /// <returns>string con la contraseña encriptada</returns>
        ...
        /// <summary>
        /// Se encarga de desencriptar la contraseña que recibe como parametro
        /// </summary>
        /// <param name="pCadena"></param>
        /// <returns>string con la contraseña desencriptada</returns>
