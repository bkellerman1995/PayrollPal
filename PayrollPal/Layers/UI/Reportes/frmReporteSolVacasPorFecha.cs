...
{
    public partial class frmReporteSolVacasPorFecha : Form
    {
        IBLLColaborador bLLColaborador = new BLLColaborador();

        DSPlanillaEnviar dSPlanillaPorFecha = new DSPlanillaEnviar();
        DSPlanillaEnviarTableAdapters.DataTable4TableAdapter tableAdapter = new DSPlanillaEnviarTableAdapters.DataTable4TableAdapter();
        public frmReporteSolVacasPorFecha()
        {
            InitializeComponent();
        }

        private void frmReporteSolVacasPorFecha_Load(object sender, EventArgs e)
        {
